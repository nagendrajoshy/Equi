...
<body background="images/equinews.png" onLoad="focus();equipage.inputString.focus()">
...
<img src="images/hea3.png" usemap="#MyMap">
<map name="MyMap">
...
<br><br>&nbsp;&nbsp;&nbsp;<INPUT type="text"  name="inputString" value="" id="inputString" onkeyup="lookup(this.value);" onblur="fill();" onmouseover="checkMouse(true);" onmouseout="checkMouse(false);" STYLE="color:"black" ; font-family: Times New Roman; font-weight: bold; font-size: 12px; background-color:"white" ;border:"blue"; size="90">&nbsp;&nbsp;&nbsp;<font size="3"></font>
...
&nbsp;&nbsp;&nbsp;<input type="submit" name="equinstan" value="equInstant" style="height: 30px; width: 150px">
<br><br><br>
