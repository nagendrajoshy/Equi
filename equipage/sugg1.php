...
//$in2=$_SESSION['prev'];
//echo $in1." ".$in2."<br>";
$select_query="select * from equi where equi.id IN (Select id from content where (content.title like '%$inputString%' and content.title like '%$in2%') or (content.keywords like '%$inputString%' and content.keywords like '%$in2%' ))
Order By rank DESC";
//echo $select_query;
$list=mysql_query($select_query);
$num = mysql_num_rows($list);
